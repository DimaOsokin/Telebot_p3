...
async def today_inlain_report_sbor(user_fio, report_today_date, report_yesterday_date):
    ...
    try:  # сборочный участок СЕГОДНЯ
        today_report_func_sbor = check_report_yesterday_or_today_sbor(report_today_date, user_fio)
    ...
    # за сегодня отчётов нет
        ...
        yesterday_report_func_sbor = check_report_yesterday_or_today_sbor(report_yesterday_date, user_fio)
