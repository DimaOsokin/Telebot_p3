...
async def calendar_auto_string(month=None, fio=None, year=None, weekends=False, next_month=False) -> str:
    ...
    SAMPLE_SPREADSHEET_ID = '1RaSJv6vl1wsqhGEmYD7db_3MS-ybS5ebyH5LXQkybiw'
    SAMPLE_RANGE_NAME_no_space = 'График ' + str(month) + f' {year}!D1:AJ'
    SAMPLE_RANGE_NAME_end_space = 'График ' + str(month) + f' {year} !D1:AJ'
